create database ansi_hands_on_ipm002;
use ansi_hands_on_ipm002;
create table Trainer_Info (trainer_id varchar(20),salutation varchar(7),trainer_name varchar(30),trainer_location varchar(30),trainer_track varchar(15),trainer_qualification varchar(100),trainer_experiance int(11),trainer_email varchar(100),trainer_password varchar(20));
...
create table Trainer_Feedback (trainer_id varchar(20),question_id varchar(20),batch_id varchar(20),module_id varchar(20),trainer_rating int);
...
('U001' 'Admin1@123','U002' 'Admin2@123');
rollback;
